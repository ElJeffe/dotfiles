...
def main(argv):
  ...
  branch910.versions.append(Version("DCM_IO", "BRANCH-DCM-Release9-10"))
  ...
  branch10_0.versions.append(Version("DCM_IO", "BRANCH-DCM-Release10-0"))
  branch10_0.versions.append(Version("DCM_MB", "BRANCH-DCM-Release10-0"))
